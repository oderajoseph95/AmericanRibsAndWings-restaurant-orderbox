-- Create SECURITY DEFINER function for order creation to bypass RLS
...
-- Grant execute to public (anonymous and authenticated users)
GRANT EXECUTE ON FUNCTION public.create_checkout_order TO anon;
