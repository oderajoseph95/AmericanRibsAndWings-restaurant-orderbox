  ...
  const onSubmit = async (data: CheckoutFormData) => {
    ...
    try {
      ...
      const orderData = {
        ...
        pickup_date: data.orderType === "pickup" && data.pickupDate 
          ? format(data.pickupDate, "yyyy-MM-dd") 
          : null,
        pickup_time: data.orderType === "pickup" && data.pickupTime
          ? data.pickupTime
          : null,
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="p-4 space-y-6">
                          ...
                          <PopoverContent className="w-auto p-0" align="start">
                            <Calendar
                              ...
                              disabled={(date) =>
                                ...
                                isBefore(addDays(new Date(), 3), date)
                              }
                              initialFocus
              ...
              {orderType === "delivery" && (
                <div className="space-y-4 p-4 border rounded-lg bg-muted/30">
                  ...
                  {(isCalculatingFee || deliveryFee !== null) && (
